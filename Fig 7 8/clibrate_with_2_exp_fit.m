...
if j>12 && j<19
start_frame=2;
end_frame=11-stop_frame/4+1;%40;
f=3;
%y0=mean(yt(1:4));
y0=yt(1);
end
...
aaa=zeros(cell_num,frame_num-1);
...
%   y_noise_ctp=y_noise_ctp/m_fix;  
   ...
   aaa(i,1:frame_num-1)=ey(1)./(y_noise_ctp(2:end)./(ey(1:end-1).*p.*(1-p)));
...
plot(10.^(res(7:12,b))./10.^(res(1:6,b)),'or')
plot(10.^(res(13:18,b))./10.^(res(1:6,b)),'sb')
legend('8-13','14-19')
...
plot(t(1:6),res(7:12,1),'sb')
%plot(t(1:6),res(7:12,2),'xb')

plot(t(1:6),res(13:18,1),'xk')
%plot(t(1:6),res(13:18,2),'xk')
...
plot(t(1:6),res(7:12,5),'sb')
%plot(t(1:6),res(7:12,2),'xb')

plot(t(1:6),res(13:18,5),'xk')
%plot(t(1:6),res(13:18,2),'xk')
...
plot(t(1:6),res(7:12,7),'sb')
%plot(t(1:6),res(7:12,2),'xb')

plot(t(1:6),res(13:18,7),'xk')
%plot(t(1:6),res(13:18,2),'xk')
...
legend('\mu','2\mu','4\mu')
xlabel('Biochemical experiments')
ylabel('Bi-exponential fit estimate')
end
...
ylabel('Bi-exponential fit estimates')
...
r=sum(hige_rmsel(1:6))/(sum(hige_rmsel(1:6))+sum(small_rmsel(1:6)))
save
