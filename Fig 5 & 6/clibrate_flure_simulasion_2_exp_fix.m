...
%%%%%%%%%%%%%%%%%%%%%%
nnn(ii)=5000; %round(200*10^(3/6));
%[ yt,frame_num ] = build_flur_matrix_p_var(45,5000,nnn(ii),1,false,0,750,0 );
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %damp  = colcolate_damp( flur,cell_num,frame_num);
   ...
   damp_pfc=damp(2:end)./damp(1:end-1);
...
hold on
plot(p_var2,v_var_m2_artical_res_no_integral,'*')
errorbar(p_var2,v_var_m,sqrt(mean_var_m))
errorbar(p_var2,v_var_m2_artical_res_no_integral,sqrt(mean_var_m2_artical_res_no_integral))
