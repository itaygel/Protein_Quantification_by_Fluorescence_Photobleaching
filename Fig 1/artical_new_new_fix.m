function [ v ] = artical_new_new_fix( flur,damp,add_noise,noise_amp,noise_bg_amp )
...
bg_amp=[];
 ...
 %flur_idial=mean(flur,2);
flur_idial=mean(flur./bg_amp,2);
%flur_idial=ones(size(flur)).*flur_idial;
flur_idial=bg_amp.*flur_idial;
